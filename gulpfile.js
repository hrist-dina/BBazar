...
gulp.task("img", () => {
  return gulp.src("./dev/img/**/*.*").pipe(gulp.dest("./public/img/"));
});
...
gulp.task("fonts", () => {
  return gulp.src("./dev/fonts/*.*").pipe(gulp.dest("./public/fonts/"));
});

gulp.task("video", () => {
  return gulp.src("./dev/video/**/*.*").pipe(gulp.dest("./public/video/"));
});
